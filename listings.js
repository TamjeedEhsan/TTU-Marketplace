      ...
      return `
        <a class="product-card" href="product.html?id=${item.id}">
          <div class="product-image">
            ...
            <button class="fav-btn${saved ? " is-active" : ""}" type="button" data-id="${item.id}" aria-label="Favorite ${item.title}">
              ${heartIcon}
            </button>
          </div>
          <div class="product-body">
            ...
            <p class="product-meta">${pinIcon}<span>${item.location}</span></p>
            <p class="product-time">${item.time}</p>
          </div>
        </a>
      `;
    })
